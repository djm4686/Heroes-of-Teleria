...
class ClassArcher(HeroClass):
    def __init__(self):
        HeroClass.__init__(self, "Archer")
        self.skills = []
        ...
        self.sprites2 = s.extractSprites((60,60), "images/Archer_walks_front_left_SS.png")
        self.sprites3 = []
        self.sprites4 = s.extractSprites((60,60), "images/Archer_walks_back_left_SS.png")
        self.sprites5 = []
