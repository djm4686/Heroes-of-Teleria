...
class TitleScene:
    def __init__(self):
        ...
        self.mapEditorButton = button.Button(self.makeText("Map Editor", 20), self.mapEditor)
    ...
    def register(self):
        ...
        if received["header"]["reqtype"] == "success":
            ...
            self.error = True
    def mapEditor(self):
        s = mapcreator.MapCreator(self.surface)
        ...
        for event in pygame.event.get():
            ...
            if self.phase.getName() == "Main":
                if event.type == MOUSEBUTTONDOWN and event.button == 1:
                    ...
                    if self.mapEditorButton.collidepoint(event.pos):
                        self.mapEditorButton.callBack()
    ...
    def draw(self, surface):
        ...
        if self.phase.getName() == "Multiplayer":
            ...
            self.mapEditorButton.draw(surface)
        elif self.phase.getName() == "Username":
            self.usernameButton.draw(surface)
            self.passwordButton.draw(surface)
            self.loginButton.draw(surface)
